...
operations_test(_Config) ->
    ...
    client:add_vertex(<<"zone0">>, <<"user">>, <<"User2">>),
    client:add_vertex(<<"zone1">>, <<"user">>, <<"User3">>),
    client:add_vertex(<<"zone2">>, <<"user">>, <<"User4">>),
    client:add_vertex(<<"zone2">>, <<"user">>, <<"User5">>),
    client:add_vertex(<<"zone0">>, <<"group">>, <<"Group1">>),
    client:add_vertex(<<"zone1">>, <<"group">>, <<"Group2">>),
    client:add_vertex(<<"zone1">>, <<"group">>, <<"Group3">>),
    client:add_vertex(<<"zone2">>, <<"group">>, <<"Group4">>),
    client:add_vertex(<<"zone0">>, <<"space">>, <<"Space1">>),
    client:add_vertex(<<"zone0">>, <<"space">>, <<"Space2">>),
    client:add_vertex(<<"zone1">>, <<"space">>, <<"Space3">>),
    client:add_vertex(<<"zone2">>, <<"space">>, <<"Space4">>),
    client:add_vertex(<<"zone0">>, <<"provider">>, <<"Provider1">>),
    client:add_vertex(<<"zone1">>, <<"provider">>, <<"Provider2">>),
    client:add_vertex(<<"zone2">>, <<"provider">>, <<"Provider3">>),

    client:add_edge(<<"zone0/User1">>, <<"zone0/Group1">>, <<"01110">>, <<"trace1">>),
    client:add_edge(<<"zone0/Group1">>, <<"zone0/Provider1">>, <<"10101">>, <<"trace2">>),
    client:add_edge(<<"zone0/User2">>, <<"zone2/Space4">>, <<"00100">>, <<"trace3">>),
    client:add_edge(<<"zone1/User3">>, <<"zone1/Group3">>, <<"00011">>, <<"trace4">>),
    client:add_edge(<<"zone1/Group3">>, <<"zone1/Group2">>, <<"00010">>, <<"trace5">>),
    client:add_edge(<<"zone1/Group2">>, <<"zone0/Space2">>, <<"10000">>, <<"trace6">>),
    client:add_edge(<<"zone1/Space3">>, <<"zone1/Provider2">>, <<"01100">>, <<"trace7">>),
    client:add_edge(<<"zone2/User4">>, <<"zone1/Group3">>, <<"01000">>, <<"trace8">>),
    client:add_edge(<<"zone1/Group3">>, <<"zone2/Group4">>, <<"10000">>, <<"trace9">>),
    client:add_edge(<<"zone2/User5">>, <<"zone2/Group4">>, <<"01101">>, <<"trace10">>),
    client:add_edge(<<"zone2/Group4">>, <<"zone2/Space4">>, <<"10111">>, <<"trace11">>),
    client:add_edge(<<"zone2/Space4">>, <<"zone1/Provider2">>, <<"11110">>, <<"trace12">>),
...
operations_after_graph_update_test(_Config) ->
    % when
    client:delete_edge(<<"zone1/Group3">>, <<"zone1/Group2">>, <<"trace5">>),
    client:delete_edge(<<"zone2/User5">>, <<"zone2/Group4">>, <<"trace10">>),
    client:set_permissions(<<"zone1/Group3">>, <<"zone2/Group4">>, <<"00010">>, <<"trace9">>),
    client:set_permissions(<<"zone2/Space4">>, <<"zone1/Provider2">>, <<"01010">>, <<"trace12">>),
    client:add_edge(<<"zone1/Group2">>, <<"zone2/Provider3">>, <<"01101">>, <<"trace13">>),
    client:add_edge(<<"zone2/User5">>, <<"zone1/Space3">>, <<"01101">>, <<"trace14">>),

-module(single_image_naive_queries_SUITE).
...
operations_test(_Config) ->
    ...
    ok = client:add_vertex(<<"zone3">>, <<"user">>, <<"User4">>),
    ok = client:add_vertex(<<"zone3">>, <<"user">>, <<"User5">>),
    ok = client:add_vertex(<<"zone1">>, <<"group">>, <<"Group1">>),
    ok = client:add_vertex(<<"zone2">>, <<"group">>, <<"Group2">>),
    ok = client:add_vertex(<<"zone2">>, <<"group">>, <<"Group3">>),
    ok = client:add_vertex(<<"zone3">>, <<"group">>, <<"Group4">>),
    ok = client:add_vertex(<<"zone1">>, <<"space">>, <<"Space1">>),
    ok = client:add_vertex(<<"zone1">>, <<"space">>, <<"Space2">>),
    ok = client:add_vertex(<<"zone2">>, <<"space">>, <<"Space3">>),
    ok = client:add_vertex(<<"zone3">>, <<"space">>, <<"Space4">>),
    ok = client:add_vertex(<<"zone1">>, <<"provider">>, <<"Provider1">>),
    ok = client:add_vertex(<<"zone2">>, <<"provider">>, <<"Provider2">>),
    ok = client:add_vertex(<<"zone3">>, <<"provider">>, <<"Provider3">>),

    ok = client:add_edge(<<"zone1:User1">>, <<"zone1:Group1">>, <<"01110">>, <<"trace1">>),
    ok = client:add_edge(<<"zone1:Group1">>, <<"zone1:Provider1">>, <<"10101">>, <<"trace2">>),
    ok = client:add_edge(<<"zone1:User2">>, <<"zone3:Space4">>, <<"00100">>, <<"trace3">>),
    ok = client:add_edge(<<"zone2:User3">>, <<"zone2:Group3">>, <<"00011">>, <<"trace4">>),
    ok = client:add_edge(<<"zone2:Group3">>, <<"zone2:Group2">>, <<"00010">>, <<"trace5">>),
    ok = client:add_edge(<<"zone2:Group2">>, <<"zone1:Space2">>, <<"10000">>, <<"trace6">>),
    ok = client:add_edge(<<"zone2:Space3">>, <<"zone2:Provider2">>, <<"01100">>, <<"trace7">>),
    ok = client:add_edge(<<"zone3:User4">>, <<"zone2:Group3">>, <<"01000">>, <<"trace8">>),
    ok = client:add_edge(<<"zone2:Group3">>, <<"zone3:Group4">>, <<"10000">>, <<"trace9">>),
    ok = client:add_edge(<<"zone3:User5">>, <<"zone3:Group4">>, <<"01101">>, <<"trace10">>),
    ok = client:add_edge(<<"zone3:Group4">>, <<"zone3:Space4">>, <<"10111">>, <<"trace11">>),
    ok = client:add_edge(<<"zone3:Space4">>, <<"zone2:Provider2">>, <<"11110">>, <<"trace12">>),
...
operations_after_graph_update_test(_Config) ->
    % when
    ok = client:delete_edge(<<"zone2:Group3">>, <<"zone2:Group2">>, <<"trace5">>),
    ok = client:delete_edge(<<"zone3:User5">>, <<"zone3:Group4">>, <<"trace10">>),
    ok = client:set_permissions(<<"zone2:Group3">>, <<"zone3:Group4">>, <<"00010">>, <<"trace9">>),
    ok = client:set_permissions(<<"zone3:Space4">>, <<"zone2:Provider2">>, <<"01010">>, <<"trace12">>),
    ok = client:add_edge(<<"zone2:Group2">>, <<"zone3:Provider3">>, <<"01101">>, <<"trace13">>),
    {error, _} = client:add_edge(<<"zone3:User5">>, <<"zone3:Space3">>, <<"01101">>, <<"trace14">>),

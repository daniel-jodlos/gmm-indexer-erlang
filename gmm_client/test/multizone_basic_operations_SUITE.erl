...
vertices_adding_test(_Config) ->
    ...
    client:add_vertex(<<"zone2">>, <<"user">>, <<"User2">>),
    client:add_vertex(<<"zone3">>, <<"user">>, <<"User3">>),
    client:add_vertex(<<"zone1">>, <<"user">>, <<"User4">>),

    client:add_vertex(<<"zone3">>, <<"group">>, <<"Group1">>),
    client:add_vertex(<<"zone2">>, <<"group">>, <<"Group2">>),

    client:add_vertex(<<"zone3">>, <<"space">>, <<"Space1">>),

    client:add_vertex(<<"zone3">>, <<"provider">>, <<"Provider1">>),
    client:add_vertex(<<"zone2">>, <<"provider">>, <<"Provider2">>),
    client:add_vertex(<<"zone1">>, <<"provider">>, <<"Provider3">>),
...
vertices_deleting_test(_Config) ->
    % when
    client:delete_vertex(<<"zone2:User2">>),
    client:delete_vertex(<<"zone3:User3">>),
    client:delete_vertex(<<"zone3:Group1">>),
...
edges_updating_test(_Config) ->
    % when
    client:set_permissions(<<"zone1:User1">>, <<"zone2:Group2">>, <<"00010">>, <<"trace2">>),
    client:set_permissions(<<"zone2:Group2">>, <<"zone3:Provider1">>, <<"11111">>, <<"trace3">>),
...
edges_deleting_test(_Config) ->
    % when
    client:delete_edge(<<"zone1:User1">>, <<"zone3:Space1">>, <<"trace1">>),
    client:delete_edge(<<"zone2:Group2">>, <<"zone3:Provider1">>, <<"trace3">>),
